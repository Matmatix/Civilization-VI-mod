...
VALUES	('CIVILIZATION_MWK_CIV_AMERICA',	'LEADER_MWK_BEN_SHAPIRO',	'BUILDING_MWK_BIRCH_GOLD',			'ICON_BUILDING_MWK_BIRCH_GOLD',			'LOC_BUILDING_MWK_BIRCH_GOLD_NAME',			'LOC_BUILDING_MWK_BIRCH_GOLD_DESCRIPTION',			35),
		...
		('CIVILIZATION_MWK_CIV_AMERICA',	'LEADER_MWK_BEN_SHAPIRO',	'BUILDING_MWK_HARAMBE_MONUMENT',	'ICON_BUILDING_MWK_HARAMBE_MONUMENT',	'LOC_BUILDING_MWK_HARAMBE_MONUMENT_NAME',	'LOC_BUILDING_MWK_HARAMBE_MONUMENT_DESCRIPTION',	30);
